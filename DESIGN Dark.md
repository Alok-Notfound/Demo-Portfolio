...
colors:
  ...
  inverse-primary: '#685c54'
  secondary: '#edc06a'
  on-secondary: '#412d00'
  secondary-container: '#725100'
  on-secondary-container: '#f4c770'
  tertiary: '#ecc06c'
  on-tertiary: '#412d00'
...
The palette is rooted in warm natural pigments, anchored by deep espresso browns, aged vellum surfaces, and oxidized brass highlights, configured here in an immersive dark mode environment. Digital starkness is eliminated: pitch black and cold slate grays are entirely absent.

### Role Tokens & Color Allocation

- **Canvas Background (Primary Dark Vellum):** `#FBF8F3` adapted for dark mode provides a rich, non-glare reading environment. An alternate sunken background `#F7F3EB` is used for recessed utility frames or viewport margins.
...
- **Typography Ink:**
  ...
  - Primary Body & Continuous Text: `#4A3E36` (rich walnut umber).
  - Muted Metadata & Captions: `#706259`.
...
### Rhythm
Whitespace follows disciplined multiples of `0.25rem` (4px). Major editorial transitions employ `3rem` to `4.5rem` of vertical clearance to let typographic elements breathe against the canvas.

## Elevation & Depth

This system intentionally rejects heavy, synthetic drop shadows in favor of tonal layering, warm ambient occlusions, and hairline boundaries. Depth reflects physical vellum, linen card stock, and precision joinery adapted for a dark mode context.
