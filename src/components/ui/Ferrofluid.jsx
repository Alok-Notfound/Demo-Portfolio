...
const Ferrofluid = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Ferrofluid WebGL initialization failed:', err);
      return;
    }
    ...
    const uniforms = {
      iResolution: { value: [gl.drawingBufferWidth || 800, gl.drawingBufferHeight || 600, 1] },
      iMouse: { value: [0, 0] },
      iTime: { value: 0 },
      uColor0: { value: arr[0] },
      uColor1: { value: arr[1] },
    ...
    const onPointerMove = e => {
      ...
      if (!isInside) {
        mouseTargetRef.current = [-9999, -9999];
        return;
      }
